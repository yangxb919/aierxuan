          ...
          <div className="lg:col-span-3">
              ...
              {qualitySteps.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  {index < qualitySteps.length - 1 && (
                    <div className="absolute left-8 top-16 w-0.5 h-8 bg-[#1F4E78]/20" />
                  )}
                  
                  {/* Step Card */}
                  <div className="flex items-start gap-4 bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 group">
                    {/* Step Number Circle */}
                    <div className="flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-[#1F4E78] to-[#2E5C8A] flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300">
                      {step.number}
                    </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="bg-white rounded-xl p-6 text-center shadow-md">
                <div className="text-4xl font-bold text-[#1F4E78] mb-2">72h</div>
                <div className="text-sm text-gray-600">Burn-in Testing</div>
              </div>
              <div className="bg-white rounded-xl p-6 text-center shadow-md">
                <div className="text-4xl font-bold text-[#1F4E78] mb-2">98%</div>
          ...
          <div className="lg:col-span-2">
              ...
              {certificates.map((cert, index) => (
                ...
                >
                  <div className="aspect-[3/4] bg-gray-100 rounded-lg mb-4 overflow-hidden">
                    <img
                      src={`https://placehold.co/300x400/1F4E78/FFFFFF?text=${cert.image}`}
                      alt={cert.name}
            ...
            <div className="mt-8 bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-2">Compliance Guaranteed</h4>
