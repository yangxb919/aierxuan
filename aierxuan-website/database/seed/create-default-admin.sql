-- Create admin user table and functions
-- WARNING: Do NOT use default passwords in production!
-- Generate your own bcrypt hash using: npx bcryptjs hash "your_secure_password"
...
-- Insert admin user (FOR LOCAL DEVELOPMENT ONLY)
-- In production: create admin via secure setup script with strong password
-- Replace <YOUR_BCRYPT_HASH> with actual hash generated by: npx bcryptjs hash "your_password"
INSERT INTO admin_users (
    ...
    'admin@example.com',
    '<YOUR_BCRYPT_HASH>', -- Generate with: npx bcryptjs hash "your_secure_password"
    'admin',
    'Admin',
    'User',
    true
...
-- Insert editor user (FOR LOCAL DEVELOPMENT ONLY - OPTIONAL)
-- Replace <YOUR_BCRYPT_HASH> with actual hash
INSERT INTO admin_users (
    email,
    password_hash,
    role,
...
DO $$
BEGIN
    RAISE NOTICE 'Admin user table created successfully!';
    RAISE NOTICE 'To create admin users, update the INSERT statements above with:';
    RAISE NOTICE '  1. Your actual email address';
    RAISE NOTICE '  2. A bcrypt hash generated via: npx bcryptjs hash "your_secure_password"';
    RAISE NOTICE 'NEVER use default or weak passwords in production!';
END $$;
